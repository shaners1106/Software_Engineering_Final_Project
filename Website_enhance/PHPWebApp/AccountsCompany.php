...
<h1>Search for Account by Company Name</h1>
...
<body>
    ...
    <form action="AccountsCompany.php" method="get">
        Company Name:<br><input type="text" name="Company"><br><br><br><br>
        <input type="submit">
    </form>
    <br><br><br><br>
    <div class="container">
...
if (isset($_GET['Company']))
{
  ...
  echo"<h1>All Accounts Under $Company </h1>";
  ...
  WHERE ml.company LIKE UPPER('%$Company%');";
