...
<h1>Search for Account by Phone Number</h1>
...
<body>
    ...
    <form action="AccountsPhone.php" method="get">
        Phone Number:<br><input type="text" name="Phone"><br><br><br><br>
        <input type="submit">
    </form>
...
if (isset($_GET['Phone']))
{
  ...
  echo"<h1>All Accounts Under $Phone </h1>";
  ...
  WHERE ml.phone1 LIKE UPPER('%$Phone%');";
