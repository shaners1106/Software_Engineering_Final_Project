...
<h1>Search for Account by email</h1>

<body>
    <h4> Proper Emails Only, Please</h4>
    <!-- a form to take in the genre input. -->


    </form>
    <form action="AccountsEmail.php" method="get">
...
if (isset($_GET['Email']))
{
  ...
  echo"<h1>All Accounts Under $Email </h1>";
  ...
  WHERE ml.email1 LIKE UPPER('%$Email%');";
